...
@Component
public class WhittakerGridLocationLoader {
    private static final Logger LOGGER = LoggerFactory.getLogger(WhittakerGridLocationLoader.class);

    private BiomeRepository biomeRepository;
    private WhittakerGridLocationRepository whittakerGridLocationRepository;

    @Inject
    public WhittakerGridLocationLoader(BiomeRepository biomeRepository, WhittakerGridLocationRepository whittakerGridLocationRepository) {
        this.biomeRepository = biomeRepository;
        this.whittakerGridLocationRepository = whittakerGridLocationRepository;
    }

    @PostConstruct
    public void loadBiomeMetadata() {
